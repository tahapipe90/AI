...
public class BestFirstSearch{
	...
	public void bestFirstSearch(int adjacencyMatrix[][], int[] heuristicvalues,int source,int goal){
         ...
         for (int i = 1; i <= number_of_vertices; i++){
           ...
           for (int j = 1; j <= number_of_vertices; j++){
               ...
               if (i == j)
                ...
                bestFirstSearch.bestFirstSearch(adjacency_matrix, heuristicvalues,source,goal);
